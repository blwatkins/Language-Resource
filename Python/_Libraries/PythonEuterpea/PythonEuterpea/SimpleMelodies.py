...
Code Source: Canvas
Some melodies altered to match personal taste
'''
"""

from PythonEuterpea import SN, EN, DEN, QN, DQN, HN, DHN
from PythonEuterpea import pdPairsToMusic
...
# Frere Jacques
frerePs = ([60,62,64,60]*2) + ([64,65,67]*2) + ([67,69,67,65,64,60]*2) + ([60,55,60]*2)
...
spiderPs = [
    ...
    62,60,62,64,60]
spiderDs = [
    EN, # This is a pickup - occurs before the first beat
